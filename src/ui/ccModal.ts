...
import { clearOverlayCache, colorCaches, paletteDetectionCache } from "../core/cache"
import { MAX_OVERLAY_DIM } from "../core/constants"
import { ensureHook } from "../core/hook"
import { DEFAULT_FREE_KEYS, WPLACE_FREE, WPLACE_NAMES, WPLACE_PAID } from "../core/palette"
